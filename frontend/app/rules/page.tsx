  ...
  return (
    <PolicyPage
      ...
      sections={[
        ...
        {
          title: '스레드와 댓글 운영',
          body: '작성자는 등록 시 입력한 수정/삭제 비밀번호로 본인 글을 관리할 수 있습니다. 운영자는 신고, 법적 위험, 스팸 여부를 기준으로 스레드와 댓글을 숨김 처리할 수 있습니다.',
        },
        {
          title: '도배와 광고성 게시물',
          body: '반복 문구, 링크 과다 포함, 자동화된 작성, 카테고리와 무관한 홍보성 게시물은 제한될 수 있습니다.',
        },
        {
          title: '이미지 업로드',
